...
@pytest.mark.P0
def test_work_detail_one(login_and_logout183_session, stop_and_run_nemo):
    '''
    验证作品详情页收藏按钮功能是否正常
    '''
...
@allure.issue('https://www.tapd.cn/47849719/bugtrace/bugreports/my_view', name='TAPD-缺陷')
@pytest.mark.P0
def test_work_detail_two(login_and_logout183_session, stop_and_run_nemo):
    '''
    验证作品详情页点赞按钮功能是否正常
    '''
    d = u2.connect(f"{udid}")  # alias for u2.connect_usb('98899a474a4c535541')621QTCQH222F2
...
@allure.issue('https://www.tapd.cn/47849719/bugtrace/bugreports/my_view', name='TAPD-缺陷')
@pytest.mark.P0
def test_work_detail_three(login_and_logout183_session, stop_and_run_nemo):
    '''
    验证作品详情页分享按钮功能是否正常
    '''
    d = u2.connect(f"{udid}")  # alias for u2.connect_usb('98899a474a4c535541')621QTCQH222F2
...
@allure.issue('https://www.tapd.cn/47849719/bugtrace/bugreports/my_view', name='TAPD-缺陷')
@pytest.mark.P0
def test_work_detail_four(login_and_logout183_session, stop_and_run_nemo):
    '''
...
@allure.issue('https://www.tapd.cn/47849719/bugtrace/bugreports/my_view', name='TAPD-缺陷')
@pytest.mark.P0
def test_work_detail_five(login_and_logout183_session, stop_and_run_nemo):
    '''
...
@allure.issue('https://www.tapd.cn/47849719/bugtrace/bugreports/my_view', name='TAPD-缺陷')
@pytest.mark.P0
def test_work_detail_six(login_and_logout183_session, stop_and_run_nemo):
    '''
    验证作品详情页再创作按钮功能是否正常
    '''
    d = u2.connect(f"{udid}")  # alias for u2.connect_usb('98899a474a4c535541')621QTCQH222F2
    ...
    with allure.step('找寻作品，如果不是自己名字，才点击进去'):
        ...
        while True:
            ...
            if user_name == my_name:
                ...
                work_name = d(text=user_name).up(resourceId="com.codemao.nemo:id/tv_work_name").get_text()
...
@allure.issue('https://www.tapd.cn/47849719/bugtrace/bugreports/my_view', name='TAPD-缺陷')
@pytest.mark.P0
def test_work_detail_seven(login_and_logout183_session, stop_and_run_nemo):
    '''
    验证作品详情页再创作按钮的"稍后打开"功能是否正常
    '''
    d = u2.connect(f"{udid}")  # alias for u2.connect_usb('98899a474a4c535541')621QTCQH222F2
    # 这个用例的“稍后打开”消失较快，所以用0.1s间隔去点击
    ...
    with allure.step('此时点击“稍后打开”按钮'):
        ...
        d(resourceId="com.codemao.nemo:id/tv_open_later").click()
...
if __name__ == '__main__':
    ...
    pytest.main(["-s", "-q", "test_work_detail.py::test_work_detail_seven", "--alluredir", path_xml])
